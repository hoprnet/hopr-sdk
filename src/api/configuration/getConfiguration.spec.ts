    ...
    const expectedResponse: GetConfigurationResponseType = {
      "hopr":{
         ...
         "chain":{
            "announce":true,
            "network":"dufour",
            "provider":"https://gnosis-chain.rpc.com",
            "protocols":{
               "networks":{
                  "debug-staging":{
                     "chain":"xdai",
         ...
         "safe_module":{
            ...
            "safe_address":"0x7c8b6c46bc4f405b343b8af753a3c3edb387f6b3",
            "module_address":"0x27fcb5d6df51fc067fc2fbc1155bc0c70de77c35"
         }
      },
      "identity":{
