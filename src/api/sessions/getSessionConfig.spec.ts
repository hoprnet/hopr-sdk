...
describe('getSessionConfig', () => {
  ...
  it('throws sdkApiError when the api responds with a 400', async function () {
    nock(API_ENDPOINT)
      .get(`/api/v4/session/config/${SESSION_ID}`)
  ...
  it('throws sdkApiError when the api responds with a 404', async function () {
  ...
  it('throws sdkApiError when the api responds with a 422', async function () {
    nock(API_ENDPOINT)
      .get(`/api/v4/session/config/${SESSION_ID}`)
