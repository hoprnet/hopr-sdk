...
var getPeers_exports = {};
__export(getPeers_exports, {
  getPeers: () => getPeers
});
module.exports = __toCommonJS(getPeers_exports);
...
const getPeers = async (url, apiKey, body) => {
  ...
  const parsedRes = import_types.GetPeersResponse.safeParse(jsonResponse);
