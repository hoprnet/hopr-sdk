...
var getAddresses_exports = {};
__export(getAddresses_exports, {
  getAddresses: () => getAddresses
});
module.exports = __toCommonJS(getAddresses_exports);
var import_cross_fetch = __toESM(require("cross-fetch"));
var import_types = require("../../types");
var import_utils = require("../../utils");
const getAddresses = async (payload) => {
  const rawResponse = await (0, import_cross_fetch.default)(`${payload.url}/api/v2/account/addresses`, {
    method: "GET",
