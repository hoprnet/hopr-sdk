...
var closeChannel_exports = {};
__export(closeChannel_exports, {
  closeChannel: () => closeChannel
});
module.exports = __toCommonJS(closeChannel_exports);
...
const closeChannel = async (url, apiKey, body) => {
  ...
  const parsedRes = import_types.CloseChannelResponse.safeParse(jsonResponse);
