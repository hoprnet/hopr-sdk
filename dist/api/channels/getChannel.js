...
var getChannel_exports = {};
__export(getChannel_exports, {
  getChannel: () => getChannel
});
module.exports = __toCommonJS(getChannel_exports);
...
const getChannel = async (url, apiKey, body) => {
  ...
  const parsedRes = import_types.GetChannelResponse.safeParse(jsonResponse);
